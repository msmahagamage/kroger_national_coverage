...
nb1 = notebook(
    "01 — Prepare official Kroger-family supermarket locations",
...
nb2 = notebook(
    ...
    [
        ...
        nbf.v4.new_code_cell("print('[5/5] Coverage summary complete.')\nbrand_summary.head(30)"),
    ],
)
